...
![이미지](images/zerodl_extra2_tvm_jetson_nano/img_01.png)Jetson Nano 실물 사진
...
![이미지](images/zerodl_extra2_tvm_jetson_nano/img_02.png)이미지 굽기 완료

그런 다음 SD Card를 다시 Jetson Nano에 꽂고 전원을 연결하여 OS 설치를 마치면 됩니다. 설치 완료 후 화면은 다음과 같습니다.

![이미지](images/zerodl_extra2_tvm_jetson_nano/img_03.png)Ubuntu 18.04 시스템 설치 성공

모니터가 하나뿐이라 Windows 기반 개발 작업에 영향을 주지 않기 위해 SSH로 바로 로그인했습니다.

![이미지](images/zerodl_extra2_tvm_jetson_nano/img_04.png)Jetson Nano로 직접 원격 로그인
...
![이미지](images/zerodl_extra2_tvm_jetson_nano/img_05.png)미러 소스 업데이트 성공
...
![이미지](images/zerodl_extra2_tvm_jetson_nano/img_06.png)TVM을 정상적으로 import 가능
...
![이미지](images/zerodl_extra2_tvm_jetson_nano/img_07.png)MxNet을 정상적으로 import 가능
...
![이미지](images/zerodl_extra2_tvm_jetson_nano/img_08.png)Jetson Nano BenchMark
