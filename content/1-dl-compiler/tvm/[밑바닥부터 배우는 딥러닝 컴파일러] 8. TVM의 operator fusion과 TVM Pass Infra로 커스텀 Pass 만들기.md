...
![이미지](images/zerodl_8_tvm_operator_fusion_pass_infra/img_01.png)공통 부분식 제거 Pass
...
![이미지](images/zerodl_8_tvm_operator_fusion_pass_infra/img_02.png)TVM 코드에서도 이 점을 언급하고 있다
...
![이미지](images/zerodl_8_tvm_operator_fusion_pass_infra/img_03.png)TVM의 operator fusion Pass 규칙과 그에 대응하는 예시

다음 그림은 conv-bn-relu fusion 전후의 성능 비교를 보여 줍니다.

![이미지](images/zerodl_8_tvm_operator_fusion_pass_infra/img_04.png)operator fusion 후 명확한 가속이 보임
